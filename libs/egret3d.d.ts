    ...
    */
    class EgretMapXmlParser {
        ...
        */
         ...
         * @platform Web,Native
         */
        dirLightDatas: Array<DirectionLightData>;
        /**
         * @language zh_CN
         * 点光源数据列表
         * @version Egret 3.0
         * @platform Web,Native
         */
        pointLightDatas: Array<PointLightData>;
        /**
         * @language zh_CN
         * 是否开启配置的平行光源
         * @version Egret 3.0
    ...
    */
    class EgretMapSourceLib extends EventDispatcher {
        ...
        */
        ...
        private loadOne(loaderMap, url, source);
        private onLoaded(e);
        /**
         * @language zh_CN
         * 获取加载过的贴图信息.
