...
declare module egret3d {
    ...
    class AnimationNode {
        ...
        * @private
        */
        initNode(data: ParticleData): void;
        /**
        * @private
        */
    ...
    class MaterialPass {
       ...
       */
        ...
        */
        ...
        protected addShaderPhase(sourcePhase: {
            [shaderPhase: number]: string[];
        }, targetPhase: {
            [shaderPhase: number]: string[];
        }): void;
    ...
    */
    class ParticleColorGlobalNode extends AnimationNode {
       ...
       */
        ...
        * @压缩一个颜色值到一个float中
        */
        getGpuColor(r: number, g: number, b: number, a: number): number;
    }
}
declare module egret3d {
    /**
...
declare module egret3d {
    ...
    */
    ...
    class ParticleData {
        ...
        geomCubeH: number;
        geomCubeD: number;
        geomSphereRadius: number;
        geomSphereSegW: number;
        geomSphereSegH: number;
        birthRotationMax: Vector3D;
        birthRotationMin: Vector3D;
        birthSizeMax: Vector3D;
        birthSizeMin: Vector3D;
        /**
        * @language zh_CN
        * @version Egret 3.0
        * @platform Web,Native
   ...
   */
    class ParticleEmitter extends Mesh {
       ...
       */
        ...
        */
        update(time: number, delay: number, camera: Camera3D): void;
        buildBoudBox(vector: Vector3D): void;
    }
}
declare module egret3d {
    /**
...
declare module egret3d {
    ...
    * @platform Web,Native
    */
    class MaterialMethodData extends SourceDataBase {
        /**
         * @language zh_CN
         * 烘焙效果
         * @version Egret 3.0
...
declare module egret3d {
    ...
    * @platform Web,Native
    */
    class MaterialSphereData extends SourceDataBase {
        /**
         * @language zh_CN
         * diffuse��ͼ��������name��
         * @version Egret 3.0
         ...
         * @platform Web,Native
         */
        methods: Array<MaterialMethodData>;
        /**
         * @language zh_CN
         * ������uv����
         * @version Egret 3.0
...
declare module egret3d {
    ...
    * @platform Web,Native
    */
    class MeshData extends SourceDataBase {
        /**
         * @language zh_CN
         * 材质球索引，全局唯一
         * @version Egret 3.0
...
declare module egret3d {
    ...
    * @platform Web,Native
    */
    class LightData extends SourceDataBase {
        /**
         * @language zh_CN
         * 灯光类型
         * @version Egret 3.0
...
declare module egret3d {
     ...
     * @platform Web,Native
     */
    class EgretMaterialMethodParser {
        /**
        * @language zh_CN
        ...
        * @platform Web,Native
        */
        static parse(xml: Node): Array<MaterialMethodData>;
    }
}
declare module egret3d {
    /**
    ...
    */
    class EgretMapXmlParser {
         ...
         * @platform Web,Native
         */
        materialList: Array<MaterialSphereData>;
        /**
         * @language zh_CN
         * 相机动画文件数据列表
         * @version Egret 3.0
        ...
        */
         ...
         * @platform Web,Native
         */
        parseXml(sceneName: string, text: string): void;
        private parseCameraAnim(xml);
        /**
        * @private
        * @language zh_CN
        * 解析node节点的属性值
...
declare module egret3d {
    ...
    * @platform Web,Native
    */
    class EgretMapSourceLib extends EventDispatcher {
        ...
        * @platform Web,Native
        */
        startLoad(parser: EgretMapXmlParser): void;
        private pushSource(list, source);
        private createLoader(loaderMap, url, source);
        private onLoaded(e);
        private loadNextOne();
        /**
         * @language zh_CN
         ...
         * @platform Web,Native
         */
        getEca(name: string): CameraAnimationController;
        /**
         * @language zh_CN
         * 获取加载过的蒙皮动画
         * @param name 蒙皮动画名
         ...
         * @platform Web,Native
         */
        getEam(name: string): SkeletonAnimationClip;
        /**
         * @language zh_CN
         * 获取加载进度信息
         * @returns number
...
declare module egret3d {
    ...
    * @platform Web,Native
    */
    class EgretMapLoader extends EventDispatcher {
        private _sceneName;
        ...
        * @platform Web,Native
        */
        cameraAnims: Array<CameraAnimationController>;
        /**
         * @language zh_CN
         * 统计加载进度信息
         * @returns number（0-1）
        ...
        */
        ...
        private onSourceLibComplete(e);
        private createLight();
        private createDefaultMaterial();
        private createMaterial();
        private createMesh();
        private createCameraAnims();
        private createSkinAnimation();
    }
}
