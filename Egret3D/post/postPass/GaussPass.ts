    ...
    */
    export class GaussPass implements IPost {
        ...
        constructor() {
            ...
            this._h_postRender.setRenderToTexture(2048, 2048, FrameBufferFormat.FLOAT_RGBA);

            this._v_postRender = new PostRender("hud_vs", "gaussian_V_fs");
            this._v_postRender.setRenderToTexture(2048, 2048, FrameBufferFormat.FLOAT_RGBA);
