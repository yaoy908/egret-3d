module egret3d.GLSL {
    ...
    */
    export class ShaderBase {
        ...
        * @param att 
        */
        public connectAtt(att: Attribute) {
        ...
        * @param tempVar 
        */
        public connectTemp(tempVar: TmpVar) {
        ...
        * @param constVar 
        */
        public connectConst(constVar: ConstVar) {
        ...
        * @param varying 
        */
        public connectVarying(varying: Varying) {
        ...
        * @param unifrom 
        */
        public connectUniform(unifrom: Uniform) {
        ...
        * @param sampler 
        */
        public connectSampler(sampler: Sampler2D) {
        ...
        * @param sampler 
        */
        public connectSampler3D(sampler: Sampler3D) {
